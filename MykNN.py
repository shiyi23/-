...
def classifyPerson():
    ...
    personTats = float(raw_input("percent of time ?"))
    ffMiles = float(raw_input("frequent ?"))
    iceCream = float(raw_input("liters of ice ?"))
    datingDataMat,datingLabels = file2matrix('datingTestSet2.txt')
    normMat,ranges,minVals = autoNorm(datingDataMat)
    inArr = array([personTats,ffMiles,iceCream])
...
# print 'testVector[0,32:63]:',testVector[0,32:63]
